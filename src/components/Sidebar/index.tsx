          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <img
                    src="../public/images/agent_dashboard.png"
                    alt=""
              ...
              <li>
                ...
                >
                  <img
                    src="../public/images/news&resources.png"
                    alt=""
                    className="opacity-100 max-w-[28px]"
                  />
                  News & Resources
