...
export default function ArrivedAtLocalHubOrderDetails() {
    ...
    const add_review = async () => {
        if (review === "") {
            error_toaster("Please enter your review!");
            return false;
        }
        SetLoading(true)
        let res = await PostApi("add_comment", {
            review: review,
    ...
    return (
        <>
            <Leftbar />
            <Topbar main="Order Details" extend={true} sub={`Arrived at Local Hub > Order Details`} />
            <section className="relative xl:w-[calc(100%-280px)] w-[calc(100%-240px)] top-[148px] py-5 px-10 float-right space-y-8">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-x-4">
                        <div className="flex gap-x-4">
                            <div>
                                <img src="/images/newicon.png" alt="" srcset="" />
                            </div>
                            <div>
                                <p className="text-lg font-semibold text-black"><Moment format="D MMM , YYYY">
                        ...
                        <div className="flex gap-x-4">
                            <div>
                                <img src="/images/Group 10492.png" alt="" srcset="" />
                            </div>
                            <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      {data?.data?.booking?.Packages?.map((pack, index) => (
                        ...
                        >
                          ...
                          <p>Billable Weight: {pack.captureBillableWeight ?? ""} kg</p>
                          <p>
                            Volumetric Weight:{" "}
                            {pack.captureVolumetricWeight }{" "}
                            cm³/5000
                          </p>
                          <p>Quantity: {pack.qty ?? ""} Packages</p>
                          <p>Volume: {pack.captureHeight * pack.captureLength * pack.captureWidth}  cm³</p>
                        </div>
                      ))}
                    </div>
                  </div>
         ...
         <div className="bg-white py-4 px-6 rounded-lg">
            ...
            <div className="flex justify-between items-start my-4">
              <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
                <h6 className="font-normal text-base whitespace-nowrap">Name</h6>
              ...
              <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
                <h6 className="font-normal text-base whitespace-nowrap">Email</h6>
                <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
            ...
            <div className="flex justify-between items-start my-4">
              <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
                <h6 className="font-normal text-base whitespace-nowrap">Phone</h6>
                <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
                  {data?.data?.booking?.SupplierDetail?.phone ?? ""}
                </p>
              </div>
              <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
                <h6 className="font-normal text-base whitespace-nowrap">Tracking No</h6>
                <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
          ...
          <div>
            <div className="bg-white py-4 px-6 rounded-lg">
             ...
             <div className="flex justify-between items-start my-4">
               ...
               <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
                 <h6 className="font-normal text-base whitespace-nowrap">Status</h6>
                 <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
       ...
       <div className="flex justify-between items-start my-4">
         <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Insurance</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
             {data?.data?.booking?.insurance ? "Yes" : "No"}
           </p>
         </div>
         <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Repacking</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
       ...
       <div className="flex justify-between items-start my-4">
         <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Company</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
             {data?.data?.booking?.Company?.name ?? ""}
           </p>
         </div>
         <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Service Type</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
       ...
       <div className="flex justify-between items-start my-4">
         <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Order Status</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
             {data?.data?.booking?.bookingStatus ?? ""}
           </p>
         </div>
         <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
           <h6 className="font-normal text-base whitespace-nowrap">Delivery Date&Time</h6>
           <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
          ...
          <div>
            <div className="bg-white py-4 px-6 rounded-lg">
              ...
              <div className="flex justify-between items-start my-4">
                <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
                  <h6 className="font-normal text-base whitespace-nowrap">Company Name</h6>
                  <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
                    {data.data?.booking?.DestinationDetail?.companyName ?? ""}
                  </p>
                </div>
                <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
                  <h6 className="font-normal text-base whitespace-nowrap">Contact Name</h6>
                  <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
              ...
              <div className="flex justify-between items-start my-4">
                <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
                  <h6 className="font-normal text-base whitespace-nowrap">License</h6>
                  <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
                    {data?.data?.booking?.DestinationDetail?.license ?? ""}
                  </p>
                </div>
                <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
                  <h6 className="font-normal text-base whitespace-nowrap">VAT No.</h6>
                  <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
        ...
        <div className="flex justify-between items-start my-4">
          <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
            <h6 className="font-normal text-base whitespace-nowrap">City</h6>
            <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
              {data?.data?.booking?.ConsigneeDetail?.city ?? ""}
            </p>
          </div>
          <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
            <h6 className="font-normal text-base whitespace-nowrap">Province</h6>
            <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
        ...
        <div className="flex justify-between items-start my-4">
          <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
            <h6 className="font-normal text-base whitespace-nowrap">Origin Country</h6>
            <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
              {data?.data?.booking?.CompanyCountry?.originCountry?.name ?? ""}
            </p>
          </div>
          <div className="flex flex-col items-start gap-y-1 w-1/2 pl-2 min-w-0">
            <h6 className="font-normal text-base whitespace-nowrap">Destination Country</h6>
            <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
              {data?.data?.booking?.CompanyCountry?.destinationCountry?.name ?? ""}
            </p>
          </div>
        </div>
        <div className="flex justify-between items-start my-4">
          <div className="flex flex-col items-start gap-y-1 w-1/2 pr-2 min-w-0">
            <h6 className="font-normal text-base whitespace-nowrap">Country</h6>
            <p className="font-medium text-base text-black text-opacity-40 w-full text-left truncate">
                            ...
                            <ModalBody>
                                <div className="flex gap-x-2 gap-y-2 flex-wrap">
                                    ...
                                    <div>
                                        {selectedImage && (
                                            <div>
                                                <img className="h-28 w-28 object-cover rounded-xl" alt="New Image" src={URL.createObjectURL(selectedImage)} />
                                                <br />
