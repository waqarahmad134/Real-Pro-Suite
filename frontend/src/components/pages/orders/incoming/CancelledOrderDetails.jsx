...
export default function CancelledOrderDetails() {
    ...
    return (
        <>
            <Leftbar />
            <Topbar main="Order Details" extend={true} sub={`Cancelled Order Details`} />
            <section className="relative xl:w-[calc(100%-280px)] w-[calc(100%-240px)] top-[148px] py-5 px-10 float-right space-y-8">
                <div className="flex justify-between">
                    ...
                    <div className="bg-themeYellow3 h-fit p-2 border-2 border-themeYellow rounded-lg">
                       <div className="flex justify-center items-center gap-x-2">
                        <img src="/images/Group 2175 (2).png" alt="image" />
                        <p>This order is cancelled by user</p>
                       </div>
                    </div>
                </div>
